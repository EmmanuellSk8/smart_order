...
import KitchenOrderPanel from "./orders/kitchen-order-panel/KitchenOrderPanel";
import OrderDetails from "./orders/kitchen-order-panel/OrderDetails";
        ...
        {currentTab === "orders" ? (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 min-h-full">
            ...
            {selectedOrder ? (
              ...
              <p className="text-center text-gray-500">Seleccione un pedido</p>
            )}
          </div>
        ) : (
          <div className="p-4 min-h-full">
            {currentTab === "categories" && <p>Contenido de Por Categorias</p>}
